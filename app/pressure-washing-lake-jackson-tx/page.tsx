...
export const metadata: Metadata = {
  ...
  description:
    'BlueLine Services provides pressure washing, soft washing, driveway cleaning, roof cleaning, house washing, concrete cleaning, and commercial exterior cleaning in Lake Jackson, TX. Call or text 832-557-8758 for a free quote.',
  keywords: [
    ...
    'concrete cleaning Lake Jackson TX',
    'commercial pressure washing Lake Jackson TX',
    'exterior cleaning Lake Jackson TX',
    'patio cleaning Lake Jackson TX',
    'sidewalk cleaning Lake Jackson TX',
    'fence cleaning Lake Jackson TX',
    'storefront cleaning Lake Jackson TX',
    'Gulf Coast pressure washing',
    'algae removal',
    'mildew removal',
    'grime removal',
    'free quote pressure washing',
    'local pressure washing Lake Jackson',
  ],
  alternates: {
    canonical: 'https://www.bluelineproservices.com/pressure-washing-lake-jackson-tx',
  },
  openGraph: {
    title: 'Pressure Washing Lake Jackson, TX | BlueLine Services',
    description: 'Professional pressure washing, soft washing, driveway cleaning, roof cleaning, house washing, and exterior cleaning for Lake Jackson, TX homes and businesses.',
    url: 'https://www.bluelineproservices.com/pressure-washing-lake-jackson-tx',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'BlueLine Services — Pressure Washing in Lake Jackson, TX',
      },
    ],
    locale: 'en_US',
    type: 'website',
...
const FAQS = [
  {
    q: 'Do you offer pressure washing in Lake Jackson, TX?',
    a: 'Yes. BlueLine Services provides pressure washing, soft washing, driveway cleaning, house washing, roof cleaning, concrete cleaning, and commercial exterior cleaning in Lake Jackson, TX.',
  },
  {
  ...
  {
    q: 'Do you clean driveways and sidewalks in Lake Jackson?',
    a: 'Yes. BlueLine Services cleans driveways, sidewalks, patios, pool decks, walkways, and other concrete surfaces in Lake Jackson and nearby areas.',
  },
  {
    q: 'Do you offer commercial pressure washing in Lake Jackson?',
  ...
  {
    q: 'How often should Lake Jackson properties be cleaned?',
  ...
  {
    q: 'What areas near Lake Jackson do you serve?',
    a: 'BlueLine Services serves Lake Jackson, Clute, Freeport, Richwood, Angleton, Brazoria, Sweeny, Bay City, Sargent, Matagorda, Van Vleck, Markham, Cedar Lake, Cedar Lane, and nearby Gulf Coast Texas communities.',
  },
];
  ...
  return (
    <main>
      ...
      <section className="bg-hero-gradient py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <p className="text-blue-400 font-bold uppercase tracking-widest text-sm mb-3">
            Lake Jackson, TX Exterior Cleaning
          </p>
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-white uppercase leading-tight mb-4">
            Pressure Washing <span className="text-blue-400">Lake Jackson, TX</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            BlueLine Services provides professional pressure washing, soft washing, and exterior cleaning for homes, driveways, sidewalks, patios, pool decks, fences, roofs, storefronts, rental properties, and commercial properties in Lake Jackson, TX.
          </p>
          ...
          <p className="text-gray-400 text-sm mt-6">
            Family-owned exterior cleaning serving Lake Jackson and nearby Gulf Coast communities.
          </p>
        </div>
      </section>
      ...
      <section className="bg-navy-800 border-y border-blue-900/30 py-6">
        <div className="max-w-5xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          ...
          <div>
            ...
            <div className="text-gray-400 text-sm">Serving Lake Jackson & coast</div>
          </div>
        </div>
      </section>

      {/* Problem Section: Exterior Cleaning Built for Lake Jackson Properties */}
      <section className="py-12 md:py-16">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="font-display text-2xl md:text-3xl font-bold text-white uppercase mb-4">
            Exterior Cleaning Built for Lake Jackson Properties
          </h2>
          <p className="text-gray-300 leading-relaxed mb-4">
            Lake Jackson properties deal with Gulf Coast humidity, algae, mildew, pollen, dirt, roof streaks, concrete stains, and constant weather exposure. BlueLine Services helps homeowners and businesses keep their property looking clean, protected, and well maintained with professional pressure washing and soft washing services.
          </p>
      ...
      <section className="bg-navy-800 py-12 md:py-16">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="font-display text-2xl md:text-3xl font-bold text-white uppercase text-center mb-8">
            Pressure Washing & Soft Washing Services in <span className="text-blue-400">Lake Jackson, TX</span>
          </h2>
      ...
      <section className="py-12 md:py-16">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="font-display text-2xl md:text-3xl font-bold text-white uppercase mb-4">
            Commercial Pressure Washing in Lake Jackson
          </h2>
          <p className="text-gray-300 leading-relaxed mb-4">
            BlueLine Services also helps Lake Jackson businesses keep their exterior areas clean and professional. We clean storefronts, sidewalks, entryways, parking areas, dumpster pads, concrete surfaces, and other high-traffic exterior areas.
          </p>
          <p className="text-gray-300 leading-relaxed mb-4">
            We work with storefronts, offices, restaurants, shops, rental properties, property managers, small businesses, and commercial buildings throughout Lake Jackson and the surrounding area.
          </p>
      ...
      <section className="py-12 md:py-16">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="font-display text-2xl md:text-3xl font-bold text-white uppercase mb-4">
            Areas Near Lake Jackson We Serve
          </h2>
          <p className="text-gray-300 leading-relaxed mb-4">
            BlueLine Services proudly serves Lake Jackson and nearby Gulf Coast Texas communities, including Clute, Freeport, Richwood, Angleton, Brazoria, Sweeny, Bay City, Sargent, Matagorda, Van Vleck, Markham, Cedar Lake, Cedar Lane, and surrounding areas.
          </p>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-gray-300">
            {[
              'Lake Jackson, TX', 'Clute, TX', 'Freeport, TX',
      ...
      <section className="bg-hero-gradient py-12 md:py-16">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <h2 className="font-display text-2xl md:text-3xl font-bold text-white uppercase mb-4">
            Need Pressure Washing in Lake Jackson, TX?
          </h2>
          <p className="text-gray-300 mb-6">
            Call or text BlueLine Services today for a free quote on pressure washing, soft washing, driveway cleaning, roof cleaning, house washing, fence cleaning, patio cleaning, storefront cleaning, or commercial exterior cleaning in Lake Jackson, TX.
          </p>
          <a
            href="tel:8325578758"
            className="inline-flex items-center justify-center gap-2.5 bg-blue-600 hover:bg-blue-500 text-white font-bold px-6 py-4 rounded-xl transition-all duration-200 hover:scale-105 shadow-xl shadow-blue-900/50 text-lg"
