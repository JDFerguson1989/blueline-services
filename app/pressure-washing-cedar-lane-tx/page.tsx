...
export const metadata: Metadata = {
  title: 'Pressure Washing Cedar Lane, TX | Soft Washing & Exterior Cleaning | 832-557-8758',
  description:
    'BlueLine Services provides pressure washing, soft washing, driveway cleaning, roof cleaning, house washing, concrete cleaning, and exterior cleaning in Cedar Lane, TX. Call or text 832-557-8758 for a free quote.',
  keywords: [
    'pressure washing Cedar Lane TX',
    'soft washing Cedar Lane TX',
    'driveway cleaning Cedar Lane TX',
    'roof cleaning Cedar Lane TX',
    'house washing Cedar Lane TX',
    'concrete cleaning Cedar Lane TX',
    'commercial pressure washing Cedar Lane TX',
    'exterior cleaning Cedar Lane TX',
    'patio cleaning Cedar Lane TX',
    'sidewalk cleaning Cedar Lane TX',
    'fence cleaning Cedar Lane TX',
    'storefront cleaning Cedar Lane TX',
    'Gulf Coast pressure washing',
    'algae removal',
    'mildew removal',
    'grime removal',
    'free quote pressure washing',
    'local pressure washing Cedar Lane',
  ],
  alternates: {
    canonical: 'https://www.bluelineproservices.com/pressure-washing-cedar-lane-tx',
  },
  openGraph: {
    title: 'Pressure Washing Cedar Lane, TX | BlueLine Services',
    description: 'Professional pressure washing, soft washing, driveway cleaning, roof cleaning, house washing, and exterior cleaning for Cedar Lane, TX homes and businesses.',
    url: 'https://www.bluelineproservices.com/pressure-washing-cedar-lane-tx',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'BlueLine Services — Pressure Washing in Cedar Lane, TX',
      },
    ],
    locale: 'en_US',
    type: 'website',
...
const FAQS = [
  {
    q: 'Do you offer pressure washing in Cedar Lane, TX?',
    a: 'Yes. BlueLine Services provides pressure washing, soft washing, driveway cleaning, house washing, roof cleaning, concrete cleaning, and exterior cleaning in Cedar Lane, TX.',
  },
  {
  ...
  {
    q: 'Do you clean driveways and sidewalks in Cedar Lane?',
    a: 'Yes. BlueLine Services cleans driveways, sidewalks, patios, pool decks, walkways, and other concrete surfaces in Cedar Lane and nearby areas.',
  },
  {
    q: 'Do you offer commercial pressure washing in Cedar Lane?',
  ...
  {
    q: 'How often should Cedar Lane properties be cleaned?',
  ...
  {
    q: 'What areas near Cedar Lane do you serve?',
    a: 'BlueLine Services serves Cedar Lane, Cedar Lake, Brazoria, Sweeny, Bay City, Lake Jackson, Freeport, Sargent, West Columbia, Van Vleck, Markham, Matagorda, Angleton, Clute, Richwood, and nearby Gulf Coast communities.',
  },
];
  ...
  return (
    <main>
      ...
      <section className="bg-hero-gradient py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <p className="text-blue-400 font-bold uppercase tracking-widest text-sm mb-3">
            Cedar Lane, TX Exterior Cleaning
          </p>
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-white uppercase leading-tight mb-4">
            Pressure Washing <span className="text-blue-400">Cedar Lane, TX</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            BlueLine Services provides professional pressure washing, soft washing, and exterior cleaning for homes, driveways, sidewalks, patios, pool decks, fences, roofs, storefronts, rental properties, and commercial properties in Cedar Lane, TX.
          </p>
          ...
          <p className="text-gray-400 text-sm mt-6">
            Family-owned exterior cleaning serving Cedar Lane and nearby Gulf Coast communities.
          </p>
        </div>
      </section>
      ...
      <section className="bg-navy-800 border-y border-blue-900/30 py-6">
        <div className="max-w-5xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          ...
          <div>
            ...
            <div className="text-gray-400 text-sm">Serving Cedar Lane & coast</div>
          </div>
        </div>
      </section>

      {/* Problem Section: Exterior Cleaning Built for Cedar Lane Properties */}
      <section className="py-12 md:py-16">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="font-display text-2xl md:text-3xl font-bold text-white uppercase mb-4">
            Exterior Cleaning Built for Cedar Lane Properties
          </h2>
          <p className="text-gray-300 leading-relaxed mb-4">
            Cedar Lane properties deal with Gulf Coast humidity, algae, mildew, pollen, dirt, roof streaks, concrete stains, and constant weather exposure. BlueLine Services helps homeowners and businesses keep their property looking clean, protected, and well maintained with professional pressure washing and soft washing services.
          </p>
      ...
      <section className="bg-navy-800 py-12 md:py-16">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="font-display text-2xl md:text-3xl font-bold text-white uppercase text-center mb-8">
            Pressure Washing & Soft Washing Services in <span className="text-blue-400">Cedar Lane, TX</span>
          </h2>
      ...
      <section className="py-12 md:py-16">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="font-display text-2xl md:text-3xl font-bold text-white uppercase mb-4">
            Commercial Pressure Washing in Cedar Lane
          </h2>
          <p className="text-gray-300 leading-relaxed mb-4">
            BlueLine Services also helps Cedar Lane businesses keep their exterior areas clean and professional. We clean storefronts, sidewalks, entryways, parking areas, dumpster pads, concrete surfaces, and other high-traffic exterior areas.
          </p>
          <p className="text-gray-300 leading-relaxed mb-4">
            We work with storefronts, offices, restaurants, shops, rental properties, property managers, small businesses, and commercial buildings throughout Cedar Lane and the surrounding area.
          </p>
      ...
      <section className="py-12 md:py-16">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="font-display text-2xl md:text-3xl font-bold text-white uppercase mb-4">
            Areas Near Cedar Lane We Serve
          </h2>
          <p className="text-gray-300 leading-relaxed mb-4">
            BlueLine Services serves Cedar Lane and nearby Gulf Coast Texas communities, including Cedar Lake, Brazoria, Sweeny, Bay City, Lake Jackson, Freeport, Sargent, West Columbia, Van Vleck, Markham, Matagorda, Angleton, Clute, Richwood, and surrounding areas.
          </p>
      ...
      <section className="bg-hero-gradient py-12 md:py-16">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <h2 className="font-display text-2xl md:text-3xl font-bold text-white uppercase mb-4">
            Need Pressure Washing in Cedar Lane, TX?
          </h2>
          <p className="text-gray-300 mb-6">
            Call or text BlueLine Services today for a free quote on pressure washing, soft washing, driveway cleaning, roof cleaning, house washing, fence cleaning, patio cleaning, storefront cleaning, or commercial exterior cleaning in Cedar Lane, TX.
          </p>
          <a
            href="tel:8325578758"
            className="inline-flex items-center justify-center gap-2.5 bg-blue-600 hover:bg-blue-500 text-white font-bold px-6 py-4 rounded-xl transition-all duration-200 hover:scale-105 shadow-xl shadow-blue-900/50 text-lg"
