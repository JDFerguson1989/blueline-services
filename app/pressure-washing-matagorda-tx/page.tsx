...
export const metadata: Metadata = {
  title: 'Pressure Washing Matagorda, TX | Soft Washing & Exterior Cleaning | 832-557-8758',
  description:
    'BlueLine Services provides pressure washing, soft washing, driveway cleaning, roof cleaning, house washing, concrete cleaning, and commercial exterior cleaning in Matagorda, TX. Call or text 832-557-8758 for a free quote.',
  keywords: [
    'pressure washing Matagorda TX',
    'soft washing Matagorda TX',
    'driveway cleaning Matagorda TX',
    'roof cleaning Matagorda TX',
    'house washing Matagorda TX',
    'concrete cleaning Matagorda TX',
    'commercial pressure washing Matagorda TX',
    'exterior cleaning Matagorda TX',
    'patio cleaning Matagorda TX',
    'sidewalk cleaning Matagorda TX',
    'fence cleaning Matagorda TX',
    'storefront cleaning Matagorda TX',
    'Gulf Coast pressure washing',
    'algae removal',
    'mildew removal',
    'grime removal',
    'free quote pressure washing',
    'local pressure washing Matagorda',
  ],
  alternates: {
    canonical: 'https://www.bluelineproservices.com/pressure-washing-matagorda-tx',
  },
  openGraph: {
    title: 'Pressure Washing Matagorda, TX | BlueLine Services',
    description: 'Professional pressure washing, soft washing, driveway cleaning, roof cleaning, house washing, and exterior cleaning for Matagorda, TX homes and businesses.',
    url: 'https://www.bluelineproservices.com/pressure-washing-matagorda-tx',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'BlueLine Services — Pressure Washing in Matagorda, TX',
      },
    ],
    locale: 'en_US',
    type: 'website',
...
const FAQS = [
  {
    q: 'Do you offer pressure washing in Matagorda, TX?',
    a: 'Yes. BlueLine Services provides pressure washing, soft washing, driveway cleaning, house washing, roof cleaning, concrete cleaning, and commercial exterior cleaning in Matagorda, TX.',
  },
  {
  ...
  {
    q: 'Do you clean driveways and sidewalks in Matagorda?',
    a: 'Yes. BlueLine Services cleans driveways, sidewalks, patios, pool decks, walkways, and other concrete surfaces in Matagorda and nearby areas.',
  },
  {
    q: 'Do you offer commercial pressure washing in Matagorda?',
  ...
  {
    q: 'How often should Matagorda properties be cleaned?',
  ...
  {
    q: 'What areas near Matagorda do you serve?',
    a: 'BlueLine Services serves Matagorda, Sargent, Lake Jackson, Freeport, Sweeny, Brazoria, Van Vleck, Markham, Cedar Lake, Cedar Lane, Angleton, Clute, Richwood, and nearby Gulf Coast communities.',
  },
];
  ...
  return (
    <main>
      ...
      <section className="bg-hero-gradient py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <p className="text-blue-400 font-bold uppercase tracking-widest text-sm mb-3">
            Matagorda, TX Exterior Cleaning
          </p>
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-white uppercase leading-tight mb-4">
            Pressure Washing <span className="text-blue-400">Matagorda, TX</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            BlueLine Services provides professional pressure washing, soft washing, and exterior cleaning for homes, driveways, sidewalks, patios, pool decks, fences, roofs, storefronts, rental properties, and commercial properties in Matagorda, TX.
          </p>
          ...
          <p className="text-gray-400 text-sm mt-6">
            Family-owned exterior cleaning serving Matagorda and nearby Gulf Coast communities.
          </p>
        </div>
      </section>
      ...
      <section className="bg-navy-800 border-y border-blue-900/30 py-6">
        <div className="max-w-5xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          ...
          <div>
            ...
            <div className="text-gray-400 text-sm">Serving Matagorda & coast</div>
          </div>
        </div>
      </section>

      {/* Problem Section: Exterior Cleaning Built for Matagorda Properties */}
      <section className="py-12 md:py-16">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="font-display text-2xl md:text-3xl font-bold text-white uppercase mb-4">
            Exterior Cleaning Built for Matagorda Properties
          </h2>
          <p className="text-gray-300 leading-relaxed mb-4">
            Matagorda properties deal with Gulf Coast humidity, algae, mildew, pollen, dirt, roof streaks, concrete stains, and constant weather exposure. BlueLine Services helps homeowners and businesses keep their property looking clean, protected, and well maintained with professional pressure washing and soft washing services.
          </p>
      ...
      <section className="bg-navy-800 py-12 md:py-16">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="font-display text-2xl md:text-3xl font-bold text-white uppercase text-center mb-8">
            Pressure Washing & Soft Washing Services in <span className="text-blue-400">Matagorda, TX</span>
          </h2>
      ...
      <section className="py-12 md:py-16">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="font-display text-2xl md:text-3xl font-bold text-white uppercase mb-4">
            Commercial Pressure Washing in Matagorda
          </h2>
          <p className="text-gray-300 leading-relaxed mb-4">
            BlueLine Services also helps Matagorda businesses keep their exterior areas clean and professional. We clean storefronts, sidewalks, entryways, parking areas, dumpster pads, concrete surfaces, and other high-traffic exterior areas.
          </p>
          <p className="text-gray-300 leading-relaxed mb-4">
            We work with storefronts, offices, restaurants, shops, rental properties, property managers, small businesses, and commercial buildings throughout Matagorda and the surrounding area.
          </p>
      ...
      <section className="py-12 md:py-16">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="font-display text-2xl md:text-3xl font-bold text-white uppercase mb-4">
            Areas Near Matagorda We Serve
          </h2>
          <p className="text-gray-300 leading-relaxed mb-4">
            BlueLine Services serves Matagorda and nearby Gulf Coast Texas communities, including Sargent, Lake Jackson, Freeport, Sweeny, Brazoria, Van Vleck, Markham, Cedar Lake, Cedar Lane, Angleton, Clute, Richwood, and surrounding areas.
          </p>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-gray-300">
            {[
              'Matagorda, TX', 'Clute, TX', 'Richwood, TX',
              'Angleton, TX', 'Brazoria, TX',
              'Sweeny, TX', 'Sargent, TX',
              'Van Vleck, TX', 'Markham, TX',
      ...
      <section className="bg-hero-gradient py-12 md:py-16">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <h2 className="font-display text-2xl md:text-3xl font-bold text-white uppercase mb-4">
            Need Pressure Washing in Matagorda, TX?
          </h2>
          <p className="text-gray-300 mb-6">
            Call or text BlueLine Services today for a free quote on pressure washing, soft washing, driveway cleaning, roof cleaning, house washing, fence cleaning, patio cleaning, storefront cleaning, or commercial exterior cleaning in Matagorda, TX.
          </p>
          <a
            href="tel:8325578758"
            className="inline-flex items-center justify-center gap-2.5 bg-blue-600 hover:bg-blue-500 text-white font-bold px-6 py-4 rounded-xl transition-all duration-200 hover:scale-105 shadow-xl shadow-blue-900/50 text-lg"
      ...
      <section className="bg-navy-800 border-t border-blue-900/30 py-8">
        <div className="max-w-5xl mx-auto px-6 text-center space-y-4">
          <div className="flex flex-wrap justify-center gap-4 text-sm">
            ...
            <span className="text-gray-600">|</span>
            <a href="/pressure-washing-matagorda-tx" className="text-blue-400 hover:text-white transition-colors">Pressure Washing Matagorda, TX</a>
            <span className="text-gray-600">|</span>
